...
export const Lessons = [
  ...
  },
  {
    ...
    content: (
      <>
        <Text style={styles.title}><Text>第一课：英语介绍</Text></Text>

<Text><Text>英语字母</Text></Text>
<Text><Image source={require("../images/LessonX_0.png")} /></Text>
<Text>TEMPLATE– CHANGE LATER</Text>


<Text>元音和辅音</Text>
<Text>英语分成二十六个字母。五个是元音（vowels) ，二十一个是辅音 （consonants)。</Text>
...
<Text>香蕉是这句子的名词，也是一个辅音词开始得所以我们要用“a”来连上。</Text>
...
<Text>如果一个句子的主语是单数，那动词要加”s”。如果是复数名词，动词不加”s“</Text>
